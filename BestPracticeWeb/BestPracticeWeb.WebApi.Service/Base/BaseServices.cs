...
namespace BestPracticeWeb.WebApi.Service
{
    public class BaseServices<TEntity>:IBaseServices<TEntity> where TEntity:class,new()
    {
        ...
        public async Task<TEntity> QueryByExpression(Expression<Func<TEntity, bool>> whereExpression)
        {
            return await BaseDal.QueryFirst(whereExpression);
        }

        public async Task<bool> Update(TEntity entity, List<string> lstIgnoreColumns=null)
        {
            return await BaseDal.Update(entity, lstIgnoreColumns);
        }
        ...
        {
            return await BaseDal.Add(model,null);
        }
    }
}
